export const ru = {
  ...
  leadImage : {src: 'image/lead-polka.jpg', alt: 'Маршрут'},
  ...
  placeParagraphs: [
    ...
    'Климат на Алтае умеренный, поэтому ехать сюда лучше всего летом. Так вы увидите всё разнообразиеместной флоры и фауны. По лесам Алтая бродят лоси, над хребтами летают орлы, а на равнинах пасутся косули. И знаменитые манулы — тоже обитатели Алтайского края.',
  ...
  footerLinks: [
    {text:'Карты', linkTitle: 'Яндекс.Карты'},
    {text:'Погода', linkTitle: 'Яндекс.Погода'},
    {text:'Расписание', linkTitle: 'Яндекс.Расписания'},
    {text:'Календарь', linkTitle: 'Яндекс.Календарь'},
    {text:'Путешествия', linkTitle: 'Яндекс.Путешествия'}
  ],
  footerCopy: '\u00A9 2022. Алексей Пономарев'
}

export const en = {
  title: 'Russian travel',
  leadTitle: 'Russian travel',
  leadImage : {src: 'image/lead-polka.jpg', alt: 'Route'},
  leadSubtitle: 'The real country is not in the news, but here.',
  leadCaption: 'your shelf - top',
  ...
  placeParagraphs: [
    ...
    'Altai is one of the most beautiful places in Russia. First of all, because of the mountains: if you go along the ridge, you will see slopes strewn with pine trees, mountain rivers and lakes. And if you open the windows in the car, you can meet with the invisible miracle of these places - mountain air.',
    'The climate in Altai is temperate, so it is best to go here in summer. So you will see all the variety local flora and fauna. Moose roam the forests of Altai, eagles fly over the ridges, and roe deer graze on the plains. And the famous manuls are also inhabitants of the Altai Territory.',
    ...
    "Of course, it's all true. But Baikal is still an ideal place for skiing competitions. This is a sport where a skier ties himself to a motorcycle and the tandem tries to develop as much ice speed. In March 2019, a world record was set at the Baikal Mile festival - 197.011 km/h.",
    "Siberia ends not in the Urals, but in Karelia: forming the taiga Siberian larch does not grow west of Vodlozero. But here she swings 30 meters — the forests of the Karelian national parks have never known an ax because of the impenetrable swamps. Some pines are more than half a millennium old. Touch a living being who has seen the sun before Ivan the Terrible saw it. In the virgin forest for a hundred kilometers you will not meet trails. And on rare paths, trees a couple of meters from the ground are marked with bear claws. Let everyone know who's boss."
  ],
  coverTitle: 'To Baikal «on\u00A0dogs»',
  coverSubtitle: 'Based on the educational topic about the Trans-Siberian Railway - a journey from the capital to Baikal by electric trains.',
  footerLinks: [
    'Cards',
    'Weather',
    'Schedule',
  ...
  footerCopy: '\u00A9 2022. Alex Ponomarev'
}